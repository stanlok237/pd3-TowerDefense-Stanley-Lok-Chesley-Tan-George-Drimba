public static class Constants {
  ...
  public static int GAME_BACKGROUND_COLOR = 10;
  public static int GAME_STROKE_COLOR = 255;
  public static int SIDEBAR_WIDTH = 200;
  public static int NEW_WALL_BUTTON_HEIGHT = 100;
  public static int INFO_DISPLAY_HEIGHT = 300;
  public static int INFO_TEXT_COLOR = 255;
  public static int INFO_TEXT_SIZE = 14;
